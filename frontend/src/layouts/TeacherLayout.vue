    ...
    <div class="flex">
      ...
      <aside class="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-white border-r border-gray-200">
        <div class="flex items-center h-16 px-6 border-b border-gray-200">
          <h1 class="text-xl font-bold text-primary-600">Teacher Portal</h1>
        </div>
        ...
        >
          <div class="flex flex-col h-full">
            <div class="flex items-center justify-between px-4 py-3 border-b border-gray-200">
              <h1 class="text-lg font-bold text-primary-600">Teacher Portal</h1>
...
const userName = computed(() => {
  ...
  return user ? `${user.first_name} ${user.last_name}` : 'Teacher'
})
